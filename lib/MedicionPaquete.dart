...
class _MedicionPaqueteState extends State<MedicionPaquete> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Medición paquete"),backgroundColor: const Color(0xff37323e),
      ),
      body:Column(
          ...
          Expanded(
            child: Container(
              ...
              child: GridView.count(
                ...
                children: <Widget>[
                  for (var numero in numeros)RaisedButton(
                    onPressed: (){setState(() {
                      ...
                      todos.add(numero);
                      actualizarUltimos();
                      print('Para el numero '+numeros[numero-8].toString()+' tenemos '+cantidad[numero-8].toString()+' piezas');
                    });},
                    child: Text('$numero', style: TextStyle(fontSize: 20)),textColor: const Color(0xfffcfcfc),color: const Color(0xff37323e),
                  )
                ],
              ),
            ),
                ...
                child: Row( mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    Padding(
                      ...
                      child: RaisedButton(
                        onPressed: (){setState(() {
                          print('Para el numero '+todos[todos.length-1].toString()+' tenemos '+(cantidad[todos[todos.length-1]-8]-1).toString()+' piezas');
